...
if(!isset($_SESSION['TCHR_USERNAME'])){
    header("/90DEGREE/login-teacher.php");
}
...
$instiCode = $_SESSION['TCHR_INSTI_CODE'];
    ...
    <main>
        ...
        <div class="container01">
            ...
            <div class="profileInfoContainer">
                <h1 id="userName-header">Hello <?php echo $_SESSION['TCHR_NAME']; ?></h1>
                <p id="userClass-para">ICSE 8th</p>
            </div>
        </div>
        ...
        <div class="container06">
            ...
            <a href="" class="activity-anchors">
                <div class="activityCards">
                    ...
                    <label class="activityImage-labels">Give Remarks</label>
                </div>
            </a>
