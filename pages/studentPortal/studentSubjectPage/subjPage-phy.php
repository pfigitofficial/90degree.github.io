...
<head>
    ...
    <link rel="stylesheet" href="/90DEGREE/css/portalCSS/studentSubjectPage/subjPage-phy.css">
    ...
    <main>
        <div id="container01">
            <div id="infoContainer01">
                <h1 class="descriptorHeader" id="descriptorHeader01">Physics</h1>
            ...
            <div class="journeyTab-container">
                <div class="journeyTab">
                    <div class="journeyImage-container">
                        <img src="/img/compass.png" alt="" class="journeyImage">
                    </div>
