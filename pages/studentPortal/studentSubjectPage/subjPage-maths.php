...
<head>
    ...
    <link rel="stylesheet" href="/90DEGREE/css/portalCSS/studentSubjectPage/subject.css">
    ...
    <main>
        <div id="container01">
            <div id="infoContainer01">
                <h1 class="descriptorHeader" id="descriptorHeader01">Mathematics</h1>
                <p class="descriptorPara" id="descriptorPara01">6 Chapters | 30 Journeys</p>
            </div>


            <div id="infoContainer01-image">
                <img src="/90DEGREE/img/compass.png" alt="" class="infoContainerImage">
            </div>
        </div>
        <hr>
