...
$CLASS_DB_SERVER = "localhost";
$CLASS_DB_USERNAME = 'root';
$CLASS_DB_PASSWORD = '';
$CLASS_DB_NAME = 'INSTITUTIONS';

$instiCode = $_SESSION['instituteCode'];


$CLASS_DB_CON = mysqli_connect($CLASS_DB_SERVER, $CLASS_DB_USERNAME, $CLASS_DB_PASSWORD, $CLASS_DB_NAME);
$CLASS_DATA_SQL = "SELECT * FROM `instituteData_table` WHERE `instiCode`='$instiCode'";


$CLASS_DATA_RESULT = mysqli_query($CLASS_DB_CON, $CLASS_DATA_SQL);
$CLASS_DATA_ROW = mysqli_fetch_array($CLASS_DATA_RESULT);
$CLASS_DATA_COUNT = mysqli_num_rows($CLASS_DATA_RESULT);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <main>
        ...
        <div class="container01">
            ...
            <div class="profileInfoContainer">
                <h1 id="userName-header">Hello <?php echo $_SESSION['fullName']; ?></h1>
                <p id="userClass-para"><?php echo $_SESSION['board']; ?> <?php echo $_SESSION['class']; ?></p>
            </div>
        </div>
        ...
        <div class="container04">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-eng.php" class="subject-anchors">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-hin.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-maths.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-histciv.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-geog.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-comp.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-phy.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-chem.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-bio.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-sanskrit.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-artedu.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentSubjectPage/subjPage-pe.php" class="subject-anchors">
                <div class="subjectCards" id="subjectCard01">
        ...
        <div class="container03">
            ...
            <a href="/90DEGREE/pages/studentPortal/studentProgress/studentProgress.php" class="statusTable-anchor">
        ...
        <div class="container06">
            ...
            <a href="/90DEGREE/pages/activityBox/activityBox.html" class="activity-anchors">
                <div class="activityCards">
                    <div class="activityImage-container">
            ...
            <a href="/90DEGREE/pages/reviews/reviews.html" class="activity-anchors">
                <div class="activityCards">
                    <div class="activityImage-container">
            ...
            <a href="/90DEGREE/pages/encylopedia/encyclo.html" class="activity-anchors">
                <div class="activityCards">
                    <div class="activityImage-container">
            ...
            <a href="" class="activity-anchors">
                <div class="activityCards">
                    ...
                    <label class="activityImage-labels">My Exams</label>
                </div>
            </a>
            ...
            <div class="container08">
                ...
                <div class="information-container">
                    ...
                    <div class="infoContainer">
                        <h1 id="descriptor-header03"><?php echo $CLASS_DATA_ROW['instiName'] ?></h1>
                        <p id="descriptor-para"><?php echo $CLASS_DATA_ROW['instiBranch'] ?><br>+91 0000000000<br>Maharashtra, 421204</p>
                    </div>
                </div>
